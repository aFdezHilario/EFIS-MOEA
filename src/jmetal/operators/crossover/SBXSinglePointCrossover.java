...
public class SBXSinglePointCrossover extends Crossover {
	...
	public Solution[] doCrossover(Double realProbability,
		...
		Variable[] variables1 = parent1.getDecisionVariables();
		Variable[] variables2 = parent2.getDecisionVariables();
			
		ArrayReal x1 = (ArrayReal)variables1[0];
		ArrayReal x2 = (ArrayReal)variables2[0];
		/*
