...
public class Tree {
    ...
    public static boolean [] atributos;
    ...
    public void buildTree(Dataset data) throws Exception {
    	atributos = new boolean[data.numAttributes()];
    ...
    private void printTree(int depth, StringBuffer text) throws Exception {
        ...
        for (i = 0; i < sons.length; i++) {
            ...
            if (i == 0) {
            	//System.out.println("i == 0 -> "+nodeModel.attributeIndex());
            	atributos[nodeModel.attributeIndex()] = true;
